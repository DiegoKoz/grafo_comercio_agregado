...
\author{Diego Kozlowski  %
	\thanks{mail: \texttt{diegokoz92@gmail.com}}}
%

\affil{Maestría en Data Mining \& Knowledge Discovery, FCEyN-UBA}


%Maestría en Data Mining \& Knowledge Discovery, FCEyN-UBA\\ 
\maketitle
...
El análisis del comercio internacional constituye una de las principales áreas estudio de la investigación económica. Sin embargo, son escasas las métricas de análisis que logren captar la estructura mundial de la economía, manteniendo su complejidad. Al mantener una mirada de conjunto sobre el mercado mundial, los estudios tienden a concentrarse en medidas genéricas que difícilmente dan cuenta de las sutilezas existentes. Por su parte, el acceso a nuevas tecnologías para el análisis de datos constituye un aliciente para poder embeber al estudio de la economía mundial de la complejidad propia de su objeto de estudio. La teoría de grafos permite caracterizar las propiedades emergentes de una red a partir del estudio de sus características topológicas. 
En este sentido, pensar a la economía mundial como una gran red compleja puede permitir un análisis pormenorizado del carácter mundial del comercio, sin detenerse necesariamente en un país en particular. El objetivo del presente trabajo es aportar un breve marco analítico del análisis de grafos, y su aplicación en el caso del comercio internacional, con las decisiones metodológicas que esto implica. Por su parte, se buscará dar interpretación de los resultados cuantitativos alcanzados, y obtener respuestas respecto del rol que juegan determinados países en el comercio internacional, las formas de relaciones comerciales que se producen, y los cambios en la estructura del grafo que se observan con la incorporación de China al mercado mundial.
\\~\\
\textbf{Palabras Clave:} grafos, economía internacional




%\keywords{grafos|economía internacional}
\end{abstract}
...
\begin{figure}
\centering
\subfigure[1\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_1_pcnt}}
\subfigure[5\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_5_pcnt}}
\subfigure[10\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_10_pcnt}}
\subfigure[15\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_15_pcnt}}
\subfigure[20\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_20_pcnt}}
\subfigure[25\%]{\includegraphics[width=0.45\linewidth]{grafo_2011_25_pcnt}}
...
\subfigure[Grado, importaciones]{
    \includegraphics[width=.8\linewidth]{impo_densidad_degree_x_yr}
    \label{fig:distribuciones-a}}

\subfigure[Autovalor, exportaciones]{
    \includegraphics[width=.8\linewidth]{expo_densidad_autovalor_x_yr}
    \label{fig:distribuciones-b}}

\subfigure[Autovalor ponderado, exportaciones]{
    \includegraphics[width=.8\linewidth]{expo_densidad_USAvsCHN_autovalor_pond_x_yr}
