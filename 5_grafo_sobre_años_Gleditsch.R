...
ggsave("graficos/1950_2000_continent_all.png", scale = 2)
...
ggsave("graficos/1950_2000_continent_degree.png")
...
ggsave("graficos/1950_2000_continent_betwenness.png")


ggplot(closeness_continentes, aes(yr,mean_closeness, color = continent))+
  geom_line(size = 1)+
  # geom_smooth(se = T)+
  labs(x = "Año", y = "Cernanía promedio")+
  scale_color_gdocs(name= "Continente" )+
  theme_tufte()

ggsave("graficos/1950_2000_continent_closeness.png")


ggplot(autovalor_continentes, aes(yr,mean_autovalor, color = continent))+
  geom_line(size = 1)+
  # geom_smooth(se = T)+
  labs(x = "Año", y = "Autovalor promedio")+
  scale_color_gdocs(name= "Continente" )+
  theme_tufte()

ggsave("graficos/1950_2000_continent_atvlr.png")
...
ggsave("graficos/1950_2000_coef_clustering_x_yr.png", scale = 1)

ggplot(caracteristicas_impo, aes(yr,correlacion ))+
  geom_line(size = 1, color = "black")+
  geom_smooth(se = F)+
  labs(x = "Año", y = "Coeficiente de correlación")+
  # labs(title= 'Correlación de grado en grafo no dirigido',
  #      subtitle = "Importaciones, threshold 1%, según año")+
  theme_tufte()

ggsave("graficos/1950_2000_correlacion_x_yr.png", scale = 1)
...
ggplot(distribuciones_impo , aes(autovalor_pond, y = factor(yr) ))+
  ...
  scale_color_gdocs() +
  labs(y = "Año",
       title= 'Distribución de autovalor ponderado de los nodos',
       subtitle = "Importaciones, threshold 1%, según año. Detalle China y Estados Unidos")
...
ggsave("graficos/1950_2000_impo_densidad_USA_CHN_grado.png", scale = 1,height = 10, width = 7)
...
ggsave("graficos/1950_2000_impo_densidad_CHN_JPN_ROK_atvlrpnd.png", scale = 2)
...
ggsave("graficos/1950_2000_impo_densidad_GFR_UKG_FRN_atvlrpnd.png", scale = 2)
